...
public class MpsinsightApp {

    private static final Logger log = LoggerFactory.getLogger(MpsinsightApp.class);

    private final Environment env;

    public MpsinsightApp(Environment env) {
        this.env = env;
    }

    /**
     * Initializes mpsinsight.
     * <p>
    ...
    public static void main(String[] args) throws UnknownHostException {
        SpringApplication app = new SpringApplication(MpsinsightApp.class);
